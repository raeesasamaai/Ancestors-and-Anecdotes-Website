...
function ExampleModal({ example, onClose }) {
  ...
  // Wait for the modal closing animation and scroll-lock cleanup
  window.setTimeout(() => {
  ...
  /*
   * Lock the document at its current scroll position while the modal is open.
   * useLayoutEffect restores the exact position before the browser paints,
   * which prevents the visible jump to the top of the page.
   */
  useLayoutEffect(() => {
    ...
    return () => {
      /* Disable global smooth scrolling during restoration. */
    ...
    <AnimatePresence>
      {example && (
        <motion.div
          ...
          onWheel={(event) => {
            /* Do not let wheel input on the backdrop reach the page. */
            if (event.target === event.currentTarget) {
              event.preventDefault();
            }
          }}
          onTouchMove={(event) => {
            /* The modal panel remains touch-scrollable; the backdrop does not. */
            if (event.target === event.currentTarget) {
              event.preventDefault();
            }
          }}
        >
          ...
          >
            ...
            {/* Only this inner wrapper scrolls. The close button stays fixed. */}
            <div
              className="
                max-h-[calc(100dvh-2rem)]
            ...
            <div className="px-5 pb-6 pt-9 sm:px-10 sm:pb-10 lg:px-14 lg:pb-14 lg:pt-11">
              ...
              <p className="mt-8 section-body text-[#704214] text-[1.35rem] font-bold italic">
                {example.subtitle}
              </p>
              ...
              <div className="mt-9">
                {/* <h3 className="section-heading text-[1.7rem] sm:text-[1.9rem]">
              ...
              {/* <div className="mt-9">
                ...
                <p className="mt-4 section-body leading-[1.6]">
                  {example.bestFor}
                </p>
              </div> */}
          ...
          <ScrollReveal as="div" className="mt-12 grid gap-8 md:grid-cols-3">
            ...
            >
              ...
              >
                <button
                  type="button"
                  onClick={() => setSelectedExample(exampleDetails[0])}
            ...
            >
              ...
              >
                <button
                  type="button"
                  onClick={() => setSelectedExample(exampleDetails[1])}
                  aria-haspopup="dialog"
                  className="
                    pointer-events-auto
                    translate-y-24
            ...
            >
              ...
              >
                <button
                  type="button"
                  onClick={() => setSelectedExample(exampleDetails[2])}
                  aria-haspopup="dialog"
                  className="
                    pointer-events-auto
                    translate-y-24
